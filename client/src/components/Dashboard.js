...
const Dashboard = ({ notOn, setnotOn, data }) => {
    ...
    useEffect(() => {
        if (stateData[0]) {
            ...
            }).then(e => { setaccountData(e.data.accountDetails) }).catch((e) => console.log(e));
            ...
            <>
                ...
                <div>
                    ...
                    <NotiComp
                        notOn={notOn}
                    />
                    <Container style={{ opacity: dashboardEnable.opacity, zIndex: "-1", position: "relative" }} fluid onClick={(e) => setnotOn({ display: "none" })}>
