...
const accountValidator = require('./accountSchema_validator');
const accountDao = require('./account_dao');
const Logger = require('../logger/logger');
const log = new Logger('Account_Controller');
...
accountrouter.post('/transferamount', authTokenValidator, (req, res) => {
    ...
    accountDao.transferAmount(transferAmount, res, req.header('auth_token'))
        .then()
