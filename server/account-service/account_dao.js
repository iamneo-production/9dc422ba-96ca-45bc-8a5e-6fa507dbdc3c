...
const accountSchema = require('./accountSchema_model').mongoAccountSchema;
...
let accountNumberBase = 414141414141;
...
mongoose.connect(dbUrl, { useNewUrlParser: true, useCreateIndex: true, useFindAndModify: false })
    ...
    .catch(err => log.error('unable to connect, please check your connectio' + err));
